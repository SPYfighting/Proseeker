...
def main():
    ...
    parser.add_argument('--config', type=str, default=None, help='Optional config path (accepted for pipeline compatibility; runtime settings are read from config.py)')
    ...
    print("=" * 80)
    print("Entering iterative optimization pipeline (sequence-only)")
